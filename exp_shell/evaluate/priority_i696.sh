...
do
    ...
    do
        ...
        do
            ...
            echo "Avp:${AVP}, Inflows:${MAIN_HUMAN_INFLOW} ${MAIN_HUMAN_INFLOW_NO_LC} ${MAIN_RL_INFLOW} ${MERGE}"
            ...
            python3 $VISUALIZER \
                        ...
                        --num_human_to_lane_index $MAIN_HUMAN_INFLOW_NO_LC 0 \
                        --window_size $WINDOW $WINDOW $WINDOW \
                        >> ${WORKING_DIR}/EVAL_idm_${MAIN_HUMAN_INFLOW}_${MAIN_HUMAN_INFLOW_NO_LC}_${MERGE}.txt 
